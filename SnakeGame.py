...
class Snake(Tk):
    ...
    def initialSetup(self):
        ...
        self.base.configure(bg='black')
        self.snake=self.base.create_rectangle(1,1,21,21,fill="PINK")
        self.score=0
    ...
    def check_snake_coords(self):
        ...
        if i<=0 or j<=0 or ii>=500 or jj>=500:
            ...
            self.y=0
            #gameover
            self.base.create_text(220,220,text="GAME OVER",font=('arial',40,'bold'),fill='white')
            self.gameStatus=0
        return
    ...
    def move_snake(self):
        ...
        self.base.create_line(tuple(self.bodycoords),tag='snakebody',width=20,fill="PINK")
        return
...
snakeobj=Snake(className="Sunway Snake Game for Kids")
while True:
    snakeobj.update()
